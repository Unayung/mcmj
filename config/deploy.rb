...
role :web, "mcmj.com"                          # Your HTTP server, Apache/etc
role :app, "mcmj.com"                         # This may be the same as your `Web` server
role :db,  "mcmj.com"   , :primary => true # This is where Rails migrations will run
