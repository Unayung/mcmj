...
set :application, "mcmj"
set :repository,  "git@github.com:Unayung/mcmj.git"
set :deploy_to, "/home/apps/mcmj"
...
role :web, "mcmj.tw"                          # Your HTTP server, Apache/etc
role :app, "mcmj.tw"                         # This may be the same as your `Web` server
role :db,  "mcmj.tw"   , :primary => true # This is where Rails migrations will run
